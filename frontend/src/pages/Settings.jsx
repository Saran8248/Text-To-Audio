...
const Settings = ({ user, onUpdateUser, theme, onThemeChange, onLogout }) => {
  ...
  const handleFileChange = (e) => {
    ...
    reader.onloadend = () => {
      ...
      toast.info(
        'Profile picture selected. Click "Save Profile" to apply changes.',
      );
    };
  ...
  const handleSupportSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      toast.success(
        "Support request sent! We will contact you at your registered email shortly.",
      );
          ...
          <div>
            ...
            >
              ...
              <option value="en-GB-LibbyNeural">
                Libby (English UK Female)
              </option>
              <option value="en-GB-MaisieNeural">
                Maisie (English UK Female)
              </option>
              <option value="en-GB-PoppyNeural">
                Poppy (English UK Female)
              </option>
              <option value="en-GB-RyanNeural">Ryan (English UK Male)</option>
              <option value="en-GB-ThomasNeural">
                Thomas (English UK Male)
              </option>
              <option value="en-GB-OliverNeural">
                Oliver (English UK Male)
              </option>
              <option value="en-GB-JamesNeural">James (English UK Male)</option>
              <option value="en-AU-NatashaNeural">
                Natasha (English AU Female)
              </option>
              <option value="en-AU-WilliamMultilingualNeural">
                William (English AU Male)
              </option>
              <option value="de-DE-KatjaNeural">
                Katja (German Female - Soft)
              </option>
              <option value="de-DE-ConradNeural">
                Conrad (German Male - Clear)
              </option>
              <option value="de-DE-AmalaNeural">
                Amala (German Female - Warm)
              </option>
              <option value="de-DE-FlorianMultilingualNeural">
                Florian (German Male - Bold)
              </option>
              <option value="de-DE-KillianNeural">
                Killian (German Male - Bright)
              </option>
              <option value="de-DE-SeraphinaMultilingualNeural">
                Seraphina (German Female - Clear)
              </option>
              <option value="de-DE-LaraNeural">
                Lara (German Female - Soft)
              </option>
              <option value="de-DE-FelixNeural">
                Felix (German Male - Clear)
              </option>
              <option value="de-DE-GretaNeural">
                Greta (German Female - Natural)
              </option>
              ...
              <option value="ar-AE-FatimaNeural">
                Fatima (Arabic UAE Female)
              </option>
              <option value="ar-AE-HamdanNeural">
                Hamdan (Arabic UAE Male)
              </option>
              ...
              <option value="fr-FR-RemyMultilingualNeural">
                Remy (French Male)
              </option>
              <option value="fr-FR-VivienneMultilingualNeural">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-1 space-y-4 text-gray-400 text-sm">
            ...
            <div className="pt-2">
              ...
              <a
                href="mailto:support@terratern.com"
                className="text-blue-400 hover:text-blue-300"
              >
                sksaran987@gmail.com
              </a>
            </div>
            <div>
          ...
          >
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setSupportState({ ...supportState, message: e.target.value })
                }
